...
var urlforceprotocol = process.env.URL_FORCE_PROTOCOL || process.env.HMD_URL_FORCE_PROTOCOL || config.urlforceprotocol || '';
...
function getserverurl() {
    var url = '';
    if (domain) {
        var protocol = urlforceprotocol ? urlforceprotocol : (protocolusessl ? 'https://' : 'http://');
        url = protocol + domain;
